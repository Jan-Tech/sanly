...
public class RateLimitingFilter extends OncePerRequestFilter {
    ...
    private final int capacity; private final int refill; private final long durationMin;
    ...
    public RateLimitingFilter(
        ...
        this.capacity = capacity; this.refill = refill; this.durationMin = durationMin;
    }
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
        ...
        Bucket bucket = buckets.computeIfAbsent(key, k -> Bucket.builder()
                .addLimit(Bandwidth.builder().capacity(capacity)
                        .refillGreedy(refill, Duration.ofMinutes(durationMin)).build())
                .build());
