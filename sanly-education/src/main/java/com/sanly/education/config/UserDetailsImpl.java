...
public class UserDetailsImpl implements UserDetails {
    private final EducationOfficer officer;

    public UserDetailsImpl(EducationOfficer officer) {
        this.officer = officer;
    }

    public UUID getOfficerId() { return officer.getOfficerId(); }
    public String getInstitutionCode() { return officer.getInstitutionCode(); }
    public EducationOfficer getOfficer() { return officer; }
