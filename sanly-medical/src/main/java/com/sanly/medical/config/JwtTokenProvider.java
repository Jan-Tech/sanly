...
/**
 * Issues JWTs carrying username, roles, doctorId, and clinicId.
 * Recipients (e.g. future front-ends) can read doctorId/clinicId from claims
...
public class JwtTokenProvider {
    ...
    public String generateToken(UserDetailsImpl principal) {
        ...
        if (principal.getClinicId() != null) {
            builder.claim("clinicId", principal.getClinicId());
        }
