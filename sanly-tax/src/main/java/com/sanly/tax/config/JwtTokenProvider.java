...
public class JwtTokenProvider {
    ...
    public String generateToken(UserDetailsImpl p) {
        ...
        List<String> roles = p.getAuthorities().stream().map(GrantedAuthority::getAuthority).toList();
        return Jwts.builder().subject(p.getUsername()).claim("roles", roles)
    ...
    public String getUsernameFromToken(String t) { return parseClaims(t).getSubject(); }
