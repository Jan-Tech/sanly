...
public class UserDetailsImpl implements UserDetails {
    private final CourtOfficer officer;
    public UserDetailsImpl(CourtOfficer o) { this.officer = o; }
    public UUID getOfficerId()    { return officer.getOfficerId(); }
    public String getCourtCode()  { return officer.getCourtCode(); }
    public CourtOfficer getOfficer() { return officer; }
