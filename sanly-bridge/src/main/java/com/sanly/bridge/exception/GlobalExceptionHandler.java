...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(
            InstitutionNotFoundException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ErrorResponse> handleDuplicate(
            DuplicateInstitutionException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ErrorResponse> handleSuspended(
            InstitutionSuspendedException ex, HttpServletRequest req) {
        return response(HttpStatus.FORBIDDEN, "Institution Suspended", ex.getMessage(), req);
    }

    @ExceptionHandler(PermissionDeniedException.class)
    public ResponseEntity<ErrorResponse> handlePermissionDenied(
            PermissionDeniedException ex, HttpServletRequest req) {
        log.info("Permission denied: {}", ex.getMessage());
        return response(HttpStatus.FORBIDDEN, "Permission Denied", ex.getMessage(), req);
    }

    @ExceptionHandler(PermissionNotFoundException.class)
    public ResponseEntity<ErrorResponse> handlePermissionNotFound(
            PermissionNotFoundException ex, HttpServletRequest req) {
        return response(HttpStatus.NOT_FOUND, "Not Found", ex.getMessage(), req);
    }

    @ExceptionHandler(InvalidExchangeRequestException.class)
    public ResponseEntity<ErrorResponse> handleInvalidExchange(
            InvalidExchangeRequestException ex, HttpServletRequest req) {
