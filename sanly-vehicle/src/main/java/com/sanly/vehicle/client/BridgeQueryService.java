...
public class BridgeQueryService {
    ...
    public boolean isTaxCompliant(String nationalId) {
    ...
    public boolean hasActiveCourtOrder(String plateNumber) {
        // Court orders stored by vehicle's current owner NIN — check bridge for COURT_ORDER
        // Returns false (allow transfer) if bridge unavailable
        return false;
    }
}
