package com.sanly.documents.client;
...
public class NotificationClient {
    ...
    public NotificationClient(RestTemplate restTemplate,
                               ...
                               @Value("${notification.service-key:documents-default-key-change-me}") String serviceKey) {
    ...
    public void send(String citizenNationalId, String eventType, String language,
        ...
        try {
            ...
            headers.set("X-Service-Name", "SANLY_DOCUMENTS");
